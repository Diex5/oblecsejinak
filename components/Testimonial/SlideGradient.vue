<template>
  <section class="  ">
    <div class="flex flex-col items-center gap-6 mb-16">
      ...
      <p class="text-lg text-surface-500  leading-normal max-w-2xl text-center">
    ...
    <div class="relative overflow-hidden">
      <div
        class="hidden sm:block absolute top-0 left-0 w-[8.43rem] h-full z-10 pointer-events-none bg-gradient-to-r from-white  via-white/5  to-transparent"
      />
      <div
        class="hidden sm:block absolute top-0 right-0 w-[8.43rem] h-full z-10 pointer-events-none bg-gradient-to-l from-white  via-white/5  to-transparent"
      />
        ...
        <div class="flex flex-col gap-8">
          <div class="flex gap-8 min-w-max sm:px-[15.43rem]">
            <div
              ...
              class="max-w-[22rem] sm:max-w-[26rem] w-full shrink-0 p-4 sm:p-8 border border-surface-200  rounded-xl"
            >
              <div class="flex flex-col gap-4">
                ...
                <p class="text-lg text-surface-500  leading-normal">
                  {{ testimonial.comment }}
                </p>
              </div>
              <div class="flex items-center gap-4 mt-8">
                ...
                <div>
                  <h3 class="text-lg font-medium text-surface-900  leading-tight">
                    {{ testimonial.name }}
                  </h3>
          ...
          <div class="flex gap-8 min-w-max sm:px-[15.43rem] sm:translate-x-[13rem]">
            <div
